...
class _AddProfilePicState extends State<AddProfilePic> {
  XFile selectedUserAvatar;bool loading=false;
  @override
  void initState() {
          ...
          children: [
            GestureDetector(onTap: (){
              ...
              child: Container(height: 40,width: MediaQuery.of(context).size.width/1.5,
                ...
                child: Text("Selfi is readable",style: TextStyle(
            ...
            GestureDetector(onTap: (){
              ...
              child: Container(height: 40,width: MediaQuery.of(context).size.width/1.5,
                decoration: BoxDecoration(
                  ...
                  children: [
                  Icon(Icons.camera_alt_outlined,color: MainTheme.primaryColor,),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: selectedUserAvatar!=null?Container(
          height: MediaQuery.of(context).size.height,
          child:ClipRRect(
              borderRadius: BorderRadius.circular(5),
              child: selectedUserAvatar != null
                  ? Platform.isAndroid?Image.file(File(selectedUserAvatar.path),fit: BoxFit.fill,):
              Image.network(selectedUserAvatar.path,fit: BoxFit.fill,)
                  : Image.asset(
