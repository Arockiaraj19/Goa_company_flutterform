...
Future registerUser(String mobile, BuildContext context, bool isSignUp) async {
  ...
  _auth.verifyPhoneNumber(
      ...
      codeSent: (String verificationId, [int forceResendingToken]) {
        ...
        Routes.sailor(Routes.loginOtpPage, params: {"otpData": data});
      },
...
Master_function(String verificationId, String mob, bool isSignUp, otp) {
  AuthCredential authCreds = PhoneAuthProvider.credential(
      verificationId: verificationId, smsCode: otp);
  _auth.signInWithCredential(authCreds).then((dynamic result) async {
    print("done");
    if (isSignUp == true) {
