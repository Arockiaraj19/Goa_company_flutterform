...
class _GoogleMapDisplayState extends State<GoogleMapDisplay> {
  ...
  Widget build(BuildContext context) {
    ...
    TextStyle _styleBody1 =TextStyle(fontSize: ScreenUtil().setSp(MainTheme.mSecondarySubHeadingfontSize),
        fontWeight: FontWeight.w700,color: MainTheme.leadingHeadings);
    TextStyle _styleBody3 =TextStyle(fontSize: ScreenUtil().setSp(MainTheme.mPrimaryContentfontSize),
        fontWeight: FontWeight.w700,color: MainTheme.leadingHeadings);
    TextStyle _styleBody1_2 =TextStyle(fontSize: ScreenUtil().setSp(MainTheme.mPrimaryContentfontSize),
        fontWeight: FontWeight.w700,color:MainTheme.leadingHeadings);
      ...
      body: SafeArea(
        child: Stack(children: [
          ...
          child: Column(
            ...
            children: [
              Row(children: [
                Icon(Icons.pin_drop,color: Colors.red,size: 18,),
                SizedBox(width: 8,),
